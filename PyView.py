...
class MainFrame(wx.Frame):
    ...
    def initWrite(self):
        ...
        f.write("EXPERIMENT FILE : "+filename+" \n")
...
def init():
    ...
    random.seed()
    currDir = os.getcwd()
    dpdir = currDir+'\default_paradigm' #windows code
    # dpdir = currDir+'/default_paradigm' #osX code
    dlist = os.listdir(dpdir)
    if len(dlist)==1:
        filename = dpdir+ '\\' + dlist[0] #windows code
        # filename = dpdir+ '/' + dlist[0] #osX code
    else:
